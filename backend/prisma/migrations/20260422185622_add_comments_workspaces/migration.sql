...
-- CreateIndex
CREATE INDEX "Comment_connectionId_target_idx" ON "Comment"("connectionId", "target");
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_connectionId_fkey" FOREIGN KEY ("connectionId") REFERENCES "Connection"("id") ON DELETE CASCADE ON UPDATE CASCADE;
