...
function renderPrisma(er: ErDiagram, dialect: Dialect): string {
  ...
  const lines: string[] = [];
  lines.push('// Generated by DB Studio — tune by hand as needed.');
...
function renderDrizzle(er: ErDiagram, dialect: Dialect): string {
  ...
  const lines: string[] = [];
  lines.push(`// Generated by DB Studio — snapshot of current DB schema.`);
...
function renderSql(er: ErDiagram, dialect: Dialect): string {
  const lines: string[] = [];
  lines.push(`-- Schema snapshot generated by DB Studio.`);
