...
import { ChevronDown, ChevronRight, ChevronsLeft, ChevronsRight, Code2, Database, FileClock, Network, Search, Table2, Eye, BookOpen, Hammer, ShieldCheck, Archive, Timer, FileCode2, Webhook, History, Activity, Filter, BookMarked, Sparkles, } from "lucide-react";
import { api } from "@/lib/api";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, } from "@/components/ui/select";
export function Sidebar({ connectionId, collapsed, onToggleCollapse, currentSchema, onSchemaChange }) {
