...
function ResizableHandle({
  ...
  return (
    ...
    >
      {withHandle && (
        <div className="z-10 flex h-5 w-3 items-center justify-center rounded-sm border border-border bg-card data-[panel-group-direction=vertical]:h-3 data-[panel-group-direction=vertical]:w-5 data-[panel-group-direction=vertical]:rotate-90">
