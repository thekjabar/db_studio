...
import { Activity, BarChart3, BookMarked, Filter, History, Mail, Send, ShieldCheck, Sparkles, Timer, Webhook, Workflow, } from "lucide-react";
...
export function LandingFeatureCards() {
    return (_jsx("section", { className: "relative landing-animations", children: _jsxs("div", { className: "max-w-6xl mx-auto px-6 py-20 sm:py-28", children: [_jsx(ScrollReveal, { from: "up", children: _jsxs("div", { className: "text-center mb-12", children: [_jsx("div", { className: "inline-flex items-center gap-2 rounded-full border border-border bg-card/60 backdrop-blur-sm px-3 py-1 text-xs text-muted-foreground mb-4", children: "What's inside" }), _jsx("h2", { className: "text-3xl sm:text-4xl font-semibold tracking-tight", children: "Every feature a DB team actually needs." }), _jsx("p", { className: "mt-4 text-muted-foreground max-w-xl mx-auto", children: "No plugin store. No feature toggles to buy. It's all in the box." })] }) }), _jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: FEATURES.map((f, i) => (_jsx(ScrollReveal, { from: "up", 
                        ...
                        delay: (i % 3) * 80 + Math.floor(i / 3) * 40, children: _jsx(FeatureCard, { item: f }) }, f.title))) })] }) }));
}
function FeatureCard({ item }) {
    const Icon = item.icon;
    return (_jsx("div", { className: cn("group relative rounded-xl p-px overflow-hidden", "feature-card-gradient"), children: _jsxs("div", { className: "relative rounded-xl border border-border bg-card/80 backdrop-blur-sm p-5 h-full transition-colors group-hover:border-primary/30", children: [_jsx("div", { className: "h-9 w-9 rounded-md bg-primary/10 border border-primary/20 flex items-center justify-center mb-3 transition-transform group-hover:scale-110", children: _jsx(Icon, { className: "h-4 w-4 text-primary" }) }), _jsx("div", { className: "font-semibold transition-colors group-hover:text-primary", children: item.title }), _jsx("div", { className: "mt-1 text-sm text-muted-foreground leading-relaxed", children: item.body })] }) }));
}
