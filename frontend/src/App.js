...
export default function App() {
    ...
    return (_jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/signup", element: _jsx(SignupPage, {}) }), _jsx(Route, { path: "/auth/callback", element: _jsx(OAuthCallbackPage, {}) }), _jsx(Route, { path: "/auth/verify", element: _jsx(VerifyEmailPage, {}) }), _jsx(Route, { path: "/forgot-password", element: _jsx(ForgotPasswordPage, {}) }), _jsx(Route, { path: "/auth/reset", element: _jsx(ResetPasswordPage, {}) }), _jsx(Route, { path: "/connections", element: _jsx(Protected, { children: _jsx(ConnectionsPage, {}) }) }), _jsx(Route, { path: "/schedules", element: _jsx(Protected, { children: _jsx(SchedulesRoute, {}) }) }), _jsx(Route, { path: "/federated", element: _jsx(Protected, { children: _jsx(FederatedRoute, {}) }) }), _jsx(Route, { path: "/api-keys", element: _jsx(Protected, { children: _jsx(ApiKeysRoute, {}) }) }), _jsx(Route, { path: "/workspaces/:id/sso", element: _jsx(Protected, { children: _jsx(WorkspaceSsoRoute, {}) }) }), _jsx(Route, { path: "/dashboards", element: _jsx(Protected, { children: _jsx(DashboardsListRoute, {}) }) }), _jsx(Route, { path: "/dashboards/:id", element: _jsx(Protected, { children: _jsx(DashboardDetailRoute, {}) }) }), _jsx(Route, { path: "/d/:token", element: _jsx(PublicDashboardRoute, {}) }), _jsx(Route, { path: "/q/:token", element: _jsx(PublicSharedQueryRoute, {}) }), _jsx(Route, { path: "/status", element: _jsx(StatusPage, {}) }), _jsx(Route, { path: "/sessions", element: _jsx(Protected, { children: _jsx(SessionsRoute, {}) }) }), _jsx(Route, { path: "/notebooks", element: _jsx(Protected, { children: _jsx(NotebooksListRoute, {}) }) }), _jsx(Route, { path: "/notebooks/:id", element: _jsx(Protected, { children: _jsx(NotebookDetailRoute, {}) }) }), _jsxs(Route, { path: "/c/:id", element: _jsx(Protected, { children: _jsx(AppShell, {}) }), children: [_jsx(Route, { index: true, element: _jsx(Navigate, { to: "sql", replace: true }) }), _jsx(Route, { path: "t/:schema/:table", element: _jsx(TableRoute, {}) }), _jsx(Route, { path: "t/:schema", element: _jsx(TableRoute, {}) }), _jsx(Route, { path: "sql", element: _jsx(SqlRoute, {}) }), _jsx(Route, { path: "builder", element: _jsx(QueryBuilderRoute, {}) }), _jsx(Route, { path: "diff", element: _jsx(DiffRoute, {}) }), _jsx(Route, { path: "dictionary", element: _jsx(DictionaryRoute, {}) }), _jsx(Route, { path: "sensitive", element: _jsx(SensitiveScanRoute, {}) }), _jsx(Route, { path: "er", element: _jsx(ErRoute, {}) }), _jsx(Route, { path: "schema", element: _jsx(SchemaRoute, {}) }), _jsx(Route, { path: "audit", element: _jsx(AuditRoute, {}) }), _jsx(Route, { path: "query-history", element: _jsx(QueryHistoryRoute, {}) }), _jsx(Route, { path: "db-health", element: _jsx(DbHealthRoute, {}) }), _jsx(Route, { path: "reviews", element: _jsx(ReviewRequestsRoute, {}) }), _jsx(Route, { path: "row-filters", element: _jsx(RowFiltersRoute, {}) }), _jsx(Route, { path: "docs", element: _jsx(SchemaDocsRoute, {}) }), _jsx(Route, { path: "ai", element: _jsx(AiChatRoute, {}) }), _jsx(Route, { path: "migrate", element: _jsx(MigrationBuilderRoute, {}) }), _jsx(Route, { path: "saved", element: _jsx(SavedRoute, {}) }), _jsx(Route, { path: "permissions", element: _jsx(PermissionsRoute, {}) }), _jsx(Route, { path: "backup", element: _jsx(BackupRoute, {}) }), _jsx(Route, { path: "slow-queries", element: _jsx(SlowQueriesRoute, {}) }), _jsx(Route, { path: "plan-regressions", element: _jsx(PlanRegressionsRoute, {}) }), _jsx(Route, { path: "migration-export", element: _jsx(MigrationExportRoute, {}) }), _jsx(Route, { path: "webhooks", element: _jsx(WebhooksRoute, {}) }), _jsx(Route, { path: "*", element: _jsx(NotFoundPage, {}) })] }), _jsx(Route, { path: "/", element: _jsx(LandingPage, {}) }), _jsx(Route, { path: "*", element: _jsx(NotFoundPage, {}) })] }));
}
