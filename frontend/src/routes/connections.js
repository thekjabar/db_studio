...
function NewConnectionDialog({ open, onOpenChange }) {
    ...
    return (_jsx(Dialog, { open: open, onOpenChange: onOpenChange, children: _jsxs(DialogContent, { className: "max-w-lg", children: [_jsxs(DialogHeader, { children: [_jsx(DialogTitle, { children: "New connection" }), _jsx(DialogDescription, { children: "Connect to a database server." })] }), _jsxs("form", { onSubmit: submit, className: "space-y-3", children: [_jsxs("div", { className: "grid grid-cols-2 gap-3", children: [_jsxs("div", { className: "space-y-1.5", children: [_jsx(Label, { children: "Name" }), _jsx(Input, { required: true, value: name, onChange: (e) => setName(e.target.value), placeholder: "My Database" })] }), _jsxs("div", { className: "space-y-1.5", children: [_jsx(Label, { children: "Dialect" }), _jsxs(Select, { value: dialect, onValueChange: (v) => {
                                                setDialect(v);
