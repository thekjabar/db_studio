...
export const SheetContent = React.forwardRef(({ className, children, side = "right", width = "w-[480px]", ...props }, ref) => (_jsxs(DialogPrimitive.Portal, { children: [_jsx(SheetOverlay, {}), _jsxs(DialogPrimitive.Content, { ref: ref, className: cn("fixed top-0 bottom-0 z-50 flex flex-col bg-card shadow-2xl border-border", side === "right" ? `right-0 ${width} border-l` : `left-0 ${width} border-r`, "data-[state=open]:animate-in data-[state=closed]:animate-out duration-200", side === "right"
                ? "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right"
                : "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left", className), ...props, children: [children, _jsx(DialogPrimitive.Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 hover:opacity-100 transition-opacity", children: _jsx(X, { className: "h-4 w-4" }) })] })] })));
